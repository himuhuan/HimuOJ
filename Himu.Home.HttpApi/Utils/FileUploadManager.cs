...
namespace Himu.Home.HttpApi.Utils
{
    ...
    public class FileUploadManager
    {
        ...
        /// </summary>
        public FileUploadManager MaxFileSize(long fileSize)
        {
        ...
        public FileUploadManager CheckExtensions(FileExtensionChecker checker)
        {
        ...
        public FileUploadManager ChangeFileExtension(string extension)
        {
            Extension = extension;
            return this;
        }
        ...
        public FileUploadManager SaveAs(string fileName)
        {
        ...
        /// <param name="fileName">文件名</param>
        public FileUploadManager SaveAs(string path, string fileName)
        {
            RelativePath = path;
        ...
        public FileUploadManager SetRootPath(string path)
        {
            RootPath = path;
            return this;
        }
