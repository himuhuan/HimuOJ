...
// icons
import {Undo as CancelIcon, UserEdit as UserEditIcon} from "@vicons/fa";
import {LogOutRound as LogOutIcon, SaveAsRound as SaveIcon,} from "@vicons/material";
// services
...
function handleEditUserInfo() {
    viewState.isUserStateEditing = true;
}

async function handleUpdateUserInfo() {
    await UserServices.updateUserDetail(props.userInfo);
    viewState.isUserStateEditing = false;
}
...
<template>
    <div>
        ...
        <n-card class="info-card" title="个人信息">
            <template #header-extra>
                <n-button v-if="!viewState.isUserStateEditing" @click="handleEditUserInfo" type="primary" secondary
                          size="small"
                ...
                <n-space v-else>
                    <n-button @click="handleUpdateUserInfo" type="primary" secondary
                              size="small"
                              icon-placement="right">
                        <template #icon>
                            <n-icon>
                    ...
                    <n-button @click="handleCancelEditUserInfo" type="primary" secondary
                              size="small"
                              icon-placement="right">
                        <template #icon>
                            <n-icon>
            ...
            <n-descriptions label-placement="top" :columns="2">
                ...
                <n-descriptions-item>
                    ...
                    <span v-if="!viewState.isUserStateEditing">
                    {{
                    ...
                    <n-input v-else style="width: fit-content" v-model:value="props.userInfo.phoneNumber" type="text"
                             placeholder="电话"/>
                </n-descriptions-item>
        ...
        <n-card class="info-card" title="账号安全">
            <n-list :show-divider="false" hoverable clickable>
                <list-goto-item @click="resetPasswordClick" style="margin-bottom: 10px">
                    <template #icon>
                        <n-icon>
                            <user-edit-icon/>
                        </n-icon>
